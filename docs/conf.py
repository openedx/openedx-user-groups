...
"""
openedx-user-groups documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-user-groups',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/openedx-user-groups",
...
#
# html_title = 'openedx-user-groups v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Specifications for user group methods, data models, and APIs used in the management of user groups within the Open edX platform.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_user_groups'),
                os.path.join(root_path, 'openedx_user_groups/migrations')])
