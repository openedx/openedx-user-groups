#!/usr/bin/env python
"""
Package metadata for openedx_user_groups.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_user_groups', '__init__.py')
...
setup(
    name='openedx-user-groups',
    version=VERSION,
    description="""Specifications for user group methods, data models, and APIs used in the management of user groups within the Open edX platform.""",
